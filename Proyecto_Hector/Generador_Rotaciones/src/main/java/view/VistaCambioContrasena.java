...
public class VistaCambioContrasena extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botonCambiar.setBackground(new java.awt.Color(36, 56, 130));
        botonCambiar.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        botonCambiar.setForeground(new java.awt.Color(255, 255, 255));
        botonCambiar.setText("CAMBIAR");
        botonCambiar.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        bg.add(botonCambiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 370, 300, 50));
        ...
        bg.add(jPasswordF, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 270, 190, 30));
        ...
        bg.add(jPasswordF1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 320, 190, 30));
        ...
        bg.add(cajaUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 170, 190, 30));
        ...
        bg.add(cajaNumeroTrabajador, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 220, 190, 30));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/resources/img/logoAzul.png"))); // NOI18N
        bg.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 50, 240, 90));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(36, 56, 130));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText("Usuario");
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 180, 80, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(36, 56, 130));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("Nº Trabajador");
        bg.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, 100, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(36, 56, 130));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Nueva Contraseña");
        bg.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 280, 150, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(36, 56, 130));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Repetir Contraseña");
        bg.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(216, 330, -1, -1));

        jSeparator2.setForeground(new java.awt.Color(36, 56, 130));
        bg.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, 190, 10));

        jSeparator5.setForeground(new java.awt.Color(36, 56, 130));
        bg.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 250, 190, 10));

        jSeparator3.setForeground(new java.awt.Color(36, 56, 130));
        bg.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 300, 190, 10));

        jSeparator4.setForeground(new java.awt.Color(36, 56, 130));
        bg.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 350, 190, 10));
